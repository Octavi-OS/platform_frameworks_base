...
public class CollapsedStatusBarFragment extends Fragment implements CommandQueue.Callbacks,
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        mOctaviLogo = (ImageView)mStatusBar.findViewById(R.id.status_bar_logo);
        Dependency.get(DarkIconDispatcher.class).addDarkReceiver(mOctaviLogo);
    ...
    public void onDestroyView() {
        ...
        Dependency.get(DarkIconDispatcher.class).removeDarkReceiver(mOctaviLogo);
    }
...
*/
	...
	animateHide(mCenterClockLayout, animate, true);
        if (mShowLogo) {
            animateHide(mOctaviLogo, animate, true);
        }
    }
    ...
    public void showNotificationIconArea(boolean animate) {
        ...
        animateShow(mCenterClockLayout, animate);
        if (mShowLogo) {
            animateShow(mOctaviLogo, animate);
        }
    }
    ...
    public void updateSettings(boolean animate) {
        ...
        if (mNotificationIconAreaInner != null) {
            if (mShowLogo) {
                ...
                animateHide(mOctaviLogo, animate, false);
            }
        }
    }
