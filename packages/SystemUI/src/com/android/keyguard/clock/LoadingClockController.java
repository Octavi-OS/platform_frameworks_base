...
public class LoadingClockController implements ClockPlugin {
    ...
    private void setClockColors() {
        ...
        if(OctaviUtils.useLockscreenClockMinuteAccentColor(mContext) && OctaviUtils.useLockscreenClockHourAccentColor(mContext)) {
        ...
        } else if(OctaviUtils.useLockscreenClockHourAccentColor(mContext)) {
        ...
        } else if(OctaviUtils.useLockscreenClockMinuteAccentColor(mContext)) {
