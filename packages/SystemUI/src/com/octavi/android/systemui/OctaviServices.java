...
@SysUISingleton
public class OctaviServices extends VendorServices {
    ...
    @Inject
    public OctaviServices(Context context, UiEventLogger uiEventLogger, Lazy<ServiceConfigurationGoogle> serviceConfigurationGoogle, Lazy<ColumbusServiceWrapper> columbusService) {
        super(context);
