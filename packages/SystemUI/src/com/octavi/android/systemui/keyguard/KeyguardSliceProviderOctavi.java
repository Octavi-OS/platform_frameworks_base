package com.octavi.android.systemui.keyguard;
...
public class KeyguardSliceProviderOctavi extends KeyguardSliceProvider implements SmartSpaceUpdateListener {
    ...
    private static class AddShadowTask extends AsyncTask<Bitmap, Void, Bitmap> {
        ...
        private final WeakReference<KeyguardSliceProviderOctavi> mProviderReference;
        private final SmartSpaceCard mWeatherCard;

        AddShadowTask(KeyguardSliceProviderOctavi keyguardSliceProviderOctavi, SmartSpaceCard smartSpaceCard) {
            mProviderReference = new WeakReference<>(keyguardSliceProviderOctavi);
            mWeatherCard = smartSpaceCard;
            mBlurRadius = keyguardSliceProviderOctavi.getContext().getResources().getDimension(R.dimen.smartspace_icon_shadow);
        }
        ...
        public void onPostExecute(Bitmap bitmap) {
            KeyguardSliceProviderOctavi keyguardSliceProviderOctavi;
            synchronized (this) {
                mWeatherCard.setIcon(bitmap);
                keyguardSliceProviderOctavi = (KeyguardSliceProviderOctavi) mProviderReference.get();
            }
            if (keyguardSliceProviderOctavi != null) {
                keyguardSliceProviderOctavi.notifyChange();
            }
        }
    ...
    public Slice onBindSlice(Uri uri) {
        Trace.beginSection("KeyguardSliceProviderOctavi#onBindSlice");
        Slice slice;
